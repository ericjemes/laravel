...
namespace KJZ\Supercoach\Database\Query;

use Closure;
use KJZ\Supercoach\Database\Support\Arr;
use KJZ\Supercoach\Database\Support\Str;
use KJZ\Supercoach\Database\Support\Collection;
...
class Builder
{
     ...
     * @var \KJZ\Supercoach\Database\Connection
     */
    protected $connection;

    /**
     * The database query grammar instance.
     * @var \KJZ\Supercoach\Database\Query\Grammars\Grammar
     */
    protected $grammar;
     ...
     * @param  $connection
     * @param  \KJZ\Supercoach\Database\Query\Grammars\Grammar  $grammar
     * @return void
     */
     ...
     * @return \KJZ\Supercoach\Database\Query\Builder|static
     */
     ...
     * @param  \Closure|\KJZ\Supercoach\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \KJZ\Supercoach\Database\Query\Builder|static
     * @throws \Exception
     */
     ...
     * @param  \KJZ\Supercoach\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \KJZ\Supercoach\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \KJZ\Supercoach\Database\Query\Builder|static
     */
     ...
     * @param  mixed  $value
     * @return \KJZ\Supercoach\Database\Query\Expression
     */
     ...
     * @return \KJZ\Supercoach\Database\ConnectionInterface
     */
     ...
     * @return \KJZ\Supercoach\Database\Query\Grammars\Grammar
     */
