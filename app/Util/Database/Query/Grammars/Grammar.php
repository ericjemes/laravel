...
namespace KJZ\Supercoach\Database\Query\Grammars;

use KJZ\Supercoach\Database\Query\Builder;
...
class Grammar
{
     ...
     *
     * @param  \KJZ\Supercoach\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     * @param  \KJZ\Supercoach\Database\Query\Expression|string  $value
