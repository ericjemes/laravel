...
use KJZ\Supercoach\Database\Query\Grammars\Grammar as QueryGrammar;
...
class Connection
{
     ...
     * @param  \Closure $callback
     * @return mixed
     * @throws \KJZ\Supercoach\Database\Exception
     */
     ...
     * @param Exception|\KJZ\Supercoach\Database\Exception $e
     * @param  string $query
     * @param  array $bindings
     * @param  \Closure $callback
     * @return mixed
     ...
     *
     * @param  \KJZ\Supercoach\Database\Grammar $grammar
     * @return \KJZ\Supercoach\Database\Grammar
     */
